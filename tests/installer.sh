...
ASSET='herdr-agent-context-v0.3.0-aarch64-apple-darwin.tar.gz'
...
test "$asset" = "$ASSET"
test "$(HERDR_AGENT_CONTEXT_OS=Darwin HERDR_AGENT_CONTEXT_ARCH=x86_64 "$SCRIPT" --print-asset)" = "herdr-agent-context-v0.3.0-x86_64-apple-darwin.tar.gz"
test "$(HERDR_AGENT_CONTEXT_OS=Linux HERDR_AGENT_CONTEXT_ARCH=aarch64 "$SCRIPT" --print-asset)" = "herdr-agent-context-v0.3.0-aarch64-unknown-linux-gnu.tar.gz"
test "$(HERDR_AGENT_CONTEXT_OS=Linux HERDR_AGENT_CONTEXT_ARCH=amd64 "$SCRIPT" --print-asset)" = "herdr-agent-context-v0.3.0-x86_64-unknown-linux-gnu.tar.gz"
