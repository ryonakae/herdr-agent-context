...
- [x] Each generated pane label uses its own 20-column session title; manual rename and clear override only that pane's current session and never change the tab aggregate.
